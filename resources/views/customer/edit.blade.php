...
<h4 class="d-flex justify-content-center mt-3">Edit Customer Data</h4>
@section('content')
        ...
        <div class="card p-5">
            <form action="{{ route('customer.update', $item->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="phone_number" class="form-control" id="phone_number" value="{{ $item->phone_number }}">
